...
public class Main {
	...
	public void main() throws Throwable {
		...
		ReflectionHelper.hookField(ReflectionHelper.getField(Minecraft.class, "mcProfiler", "field_71424_I", "B"),
				Minecraft.getMinecraft(), new ProfilerHook());
		...
		ReflectionHelper.hookField(
				ReflectionHelper.getField(blockRendererDispatcher.getClass(), "blockModelRenderer", "field_175027_c",
						"b"),
				blockRendererDispatcher, new XRayBlockModelRenderer(Minecraft.getMinecraft().getBlockColors()));
		ConfigHelper.load();
	}
	...
	public void log(String string) {
		logger.info(String.valueOf(new StringBuilder().append("[Yammi] ").append(string)));
	}
}
