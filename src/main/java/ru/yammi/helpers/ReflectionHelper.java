...
public class ReflectionHelper {
	...
	public static MethodHandle getLookupMethod(Class<?> class_, MethodType methodType, String... arrstring)
			throws Throwable {
		for (String string : arrstring) {
	...
	public static double getRenderPosX() throws Throwable, IllegalAccessException {
		return (double) ReflectionHelper.lookup()
				.unreflectGetter(ReflectionHelper.getField(RenderManager.class, "renderPosX", "field_78725_b", "o"))
				.invoke(Minecraft.getMinecraft().getRenderManager());
	}

	public static double getRenderPosY() throws IllegalAccessException, Throwable {
		return (double) ReflectionHelper.lookup()
				.unreflectGetter(ReflectionHelper.getField(RenderManager.class, "renderPosY", "field_78726_c", "p"))
				.invoke(Minecraft.getMinecraft().getRenderManager());
	}

	public static double getRenderPosZ() throws IllegalAccessException, Throwable {
		return (double) ReflectionHelper.lookup()
				.unreflectGetter(ReflectionHelper.getField(RenderManager.class, "renderPosZ", "field_78723_d", "q"))
				.invoke(Minecraft.getMinecraft().getRenderManager());
	}
