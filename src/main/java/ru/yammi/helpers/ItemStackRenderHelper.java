...
public class ItemStackRenderHelper {
	...
	public static void drawitemStackEnchants(ItemStack itemStack, int n, int n2) {
		...
		if (nBTTagList != null) {
			...
			for (int i = 0; i < nBTTagList.tagCount(); ++i) {
				...
				Minecraft.getMinecraft().fontRenderer.drawStringWithShadow(String.valueOf(new StringBuilder()
						.append(String.valueOf(String.valueOf(string))).append("\u00a7b").append(s2)), n, n2 + n3,
						-5592406);
	...
	public static void renderItemStack(ItemStack itemStack, int n, int n2) {
		...
		Minecraft.getMinecraft().getRenderItem().renderItemOverlays(Minecraft.getMinecraft().fontRenderer, itemStack, n,
				n2);
